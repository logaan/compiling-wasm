...
impl ::core::fmt::Debug for MaybeU8 {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    match self {
      MaybeU8::None => {
        f.debug_tuple("MaybeU8::None").finish()
      }
      MaybeU8::Some(e) => {
        f.debug_tuple("MaybeU8::Some").field(e).finish()
      }
    }
  }
}
...
pub unsafe fn _export_take_cabi<T: Guest>(arg0: i32,arg1: i32,) { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();{
  let v0 = match arg0 {
    0 => {
      MaybeU8::None
...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_give_cabi<T: Guest>() -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
